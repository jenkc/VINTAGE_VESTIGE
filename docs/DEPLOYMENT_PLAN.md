...
venv/bin/python enrichment/enrich_remaining.py 100 --yes
...
```bash
venv/bin/python embeddings/scripts/generate_all_embeddings.py
```
...
```bash
venv/bin/python analysis/generate_narratives.py --batch-size=50
```
...
### D-1.3 Add Environment-Based API URL to Frontend
